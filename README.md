...
Check out the live portfolio: [Portfolio Website](https://your-portfolio-url.com)
...
| 🌓 **Dark Mode** | Eye-friendly dark/light theme |
...
- `src/pages/Home.tsx` - Personal info
- `src/assets/photo.jpg` - Profile picture
